  ...
  const projects = [
    {
      title: 'PyHelmGen',
      description:
        'PyPi library for generating Helm charts from docker-compose files. This package is used to abstract the complexity of Kubernetes deployments and provide a simple way to get applications on Kubernetes for web developers.',
      technologies: [
    ...
    },
    {
      ...
      description:
        'I used four Raspberry Pi Model B 4s to create a Kubernetes cluster. On the Pis I used Raspberry Pi OS Lite and installed K3s, a lightweight distribution of Kubernetes.',
      technologies: [
    ...
    },
    {
      ...
      description:
        'I completed this during my research in undergraduate. I wrote Bash scrips to call Twitter’s developer API, aggregate and sort the data. Then I generated word cluster topics using Word2Vec and Latent Dirichlet Analysis.',
      technologies: [
        { icon: pythonIcon, name: 'Python' },
  ...
  return (
    <>
      <div className="flex items-center justify-center min-h-[30vh] mb-4">
        <h2 className="text-4xl font-bold text-center py-8 mb-12">Portfolio</h2>
      </div>
      <div className="p-8">
